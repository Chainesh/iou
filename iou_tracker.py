...
def track_iou(detections, sigma_l, sigma_h, sigma_iou, t_min):
    ...
    for i, detections_frame in enumerate(detections, start=1):
        # apply low threshold to detections
        #print(detections_frame)
        dets = [det for det in detections_frame if det['score'] >= sigma_l]
        # dets = max([det for det in detections_frame if det['score'] >= sigma_l], key=lambda x: x['score'])
        ...
        new_tracks = [{'bboxes': [det['bbox']], 'max_score': det['score']} for det in dets]
